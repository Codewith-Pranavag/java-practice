...
public class Main {
    ...
    public static boolean isnumkeyvalid(String text){
     return text.matches("\\d+") && iskeyvalid(Integer.valueOf(text));
    }
    ...
    public static void encryption() {
        ...
        String k1 = sc.next();
        while((!isnumkeyvalid(k1))){
          System.out.print("Enter the key1 invalid found: \n");
          k1=sc.next();
        }
        int key1=Integer.valueOf(k1);
        System.out.print("Enter the key2: \n");
        String k2=sc.next();
        while(!isnumvalid(k2) ){
          System.out.print("Enter the key2 invalid found: \n");
          k2=sc.next();
        }
        int key2=Integer.valueOf(k2);
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (ch == ' ') {
                ...
                char chnew = (char) ('a' + ((p * key1) +key2)% 26);
    ...
    public static void decryption() {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (ch == ' ') {
                ...
                int kinv = findinv(key1);
                int t=(c -key2)*kinv;
                char chnew = (char) ('a' + (t%26 +26) % 26);
    ...
    public static void check(String str, int key1,int key2) {
        StringBuilder sb = new StringBuilder();
